    ...
    <input type="checkbox" id="open-aside" hidden>
        <header class="container">
            ...
            <div class="header-bottom flex-between">
                <div class="logo"><a href="/"><img src="/images/logo.png" alt="logo" height="35"></a></div>
                <nav class="d-lg-flex d-none">
                    <div class="nav-item">
                        <a href="/" class="lighter">메인페이지</a>
                    </div>
                    <div class="nav-item">
                        <a href="/register" class="lighter">펀드등록</a>
                    </div>
                    <div class="nav-item">
                        <a href="/view" class="lighter">펀드보기</a>
                    </div>
                    <div class="nav-item">
                        <a href="/investor" class="lighter">투자자목록</a>
                    </div>
                </nav>
        ...
        <aside>
            ...
            <div class="aside-content px-4">
                <div class="auth">
                    ...
                    <a class="header-btn" href="/join">회원가입</a>
