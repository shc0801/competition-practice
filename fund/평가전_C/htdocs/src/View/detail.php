    ...
    <div class="container">
        <div class="mt-4">
            ...
            <div class="t-head mt-3 pb-2">
                <div class="cell-10 flex-center"><span>펀드번호</span></div>
                <div class="cell-20 flex-center"><span>펀드등록자</span></div>
                <div class="cell-10 flex-center"><span>펀드이름</span></div>
            ...
            <form action="/detail/profile"">
                <input type="hidden" name="investor_email" value="<?=$fund->owner?>">
                <div class="t-row">
                    <div class="cell-10 flex-center"><span><?=$fund->fund_num?></span></div>
                    <div class="cell-20 flex-center"><button style="border: none; background: none;"><?=$fund->owner?></button></div>
                    <div class="cell-10 flex-center"><span><?=$fund->fund_name?></span></div>
