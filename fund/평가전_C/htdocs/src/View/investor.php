...
<div id="investor-fund" class="py-5">
    <div class="container">
        ...
        <div class="mt-4 flex-center">
            <a href="/investor?page=<?=$investors->startPage - 1?>" class="blue-btn py-2 px-3" <?=!$investors->prev ? "disabled" : ""?>>
                <i class="fa fa-angle-left"></i>
            </a>
            <?php for($i = $investors->startPage; $i <= $investors->endPage; $i++): ?>
                <a href="/investor?page=<?=$i?>" class="btn-filled py-2 px-3">
                    <?=$i?>
                </a>
            <?php endfor; ?>
            <a href="/investor?page=<?=$investors->endPage + 1?>" class="blue-btn py-2 px-3" <?=!$investors->next ? "disabled" : ""?>>
