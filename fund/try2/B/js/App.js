class App {
    ...
    addItem(item) { 
        ...
        div.innerHTML = `   <div class="card">
                                ...
                                <div class="card-footer">
                                    <button class="blue-btn w-100" data-toggle="modal" data-target="#investor-view-modal" data-id=${item.idx} value="<?=$fund->$fund_num?>">상세보기</button>
                                </div>
                            </div>`;
    ...
    modal(e) {
        ...
        modal.innerHTML = ` <div class="title">상세보기</div>
                            ...
                            <div class="mt-2">
                                <small class="text-gray">투자자리스트</small>
                                <div class="investor pl-1 pt-4" style="max-height: 450px; height: auto; overflow-y: scroll;">
