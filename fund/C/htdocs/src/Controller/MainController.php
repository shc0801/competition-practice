...
class MainController {
    ...
    function insertInvest() {
        ...
        if($investor) {
            ...
            DB::query("INSERT INTO investors(fund_num, name, email, pay, sign, datetime) VALUES(?, ?, ?, ?, ?)", [$invest_num, user()->user_name, user()->user_email, $fund_price, $sign, date("Y-m-d H-i-s")]);
        } 
